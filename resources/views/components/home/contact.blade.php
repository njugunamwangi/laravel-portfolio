                ...
                <span class="text-primary mb-4 block text-base font-semibold">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base">(+254)715 789 160</p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base">info@ndachi.dev</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                          ...
                          x-data="{
                            ...
                            submitForm(event) {
                                ...
                                .then(result => {
                                    ...
                                    this.successMessage = 'Thanks for your contact request. I will get back to you in a while.';
                                })
                    ...
                    <span class="absolute -top-10 -right-9 z-[-1]">
                        ...
                        <x-top-contact-dots></x-top-contact-dots>
                        <x-bottom-contact-dots></x-bottom-contact-dots>
                    </div>
                </div>
            </div>
        </div>
